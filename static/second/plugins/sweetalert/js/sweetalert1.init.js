document.querySelector(".sweet-success").onclick = function () {
    if (document.querySelectorAll(".is-invalid").length === 0
        & document.querySelectorAll(".val").length === 0) {
        swal("Заявка добавлена!", "Начинаем рассыллку вакансии", "success");
        document.querySelector(".confirm").onclick = function () {
            document.querySelector(".form-valide").submit();
        }
    } else {
        return true
    }
...
// let swal_q = swal("Hey, Good job !!", "You clicked the button !!", "success");
// document.querySelectorAll(".sweet-success").onclick = function () {
