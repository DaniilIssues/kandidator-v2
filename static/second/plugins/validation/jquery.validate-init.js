jQuery(".form-valide").validate({
    ...
    success: function (e) {
        jQuery(e).closest(".form-group").removeClass("val", "is-invalid").removeClass("is-invalid"), jQuery(e).remove(),
        jQuery(e).closest(".form-group").removeClass("val"), jQuery(e).remove()
    },
    rules: {
